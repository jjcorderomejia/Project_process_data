...
class load_trips_class(View):
    ...
    def get(self, request):
        ...
        query = "insert into `api_trips_group` (`region`,  `origin_coord`,  `destination_coord`,  `datetime`,  `datasource`) select `region`,  `origin_coord`,  `destination_coord`,  `datetime`,  `datasource` from `api_trips` group by `origin_coord`,  `destination_coord`,  `datetime`"
